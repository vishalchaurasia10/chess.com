...
const Hero = () => {
    return (
        <div className='pb-20 pt-5 lg:pt-0 lg:pb-0 font-firaCode flex items-center md:px-20 lg:px-20 xl:px-28 px-4 relative min-h-screen lg:bg-center bg-cover text-black bg-[url("/chess.jpg")]'>
